        ...
        return (
            ...
            <Container component="main" maxWidth="xs">
                <div className="mt-3 mt-md-5">
                    ...
                    <Typography className="mt-3 font-weight-normal" component="h1" variant="h6">Faça o seu cadastro!</Typography>
                    </div>
                    <div className="mt-4">
                        <TextField
                            variant="outlined"
                        ...
                        /> 
                        {(this.props.error.name) && <strong className='text-danger'>{this.props.error.name[0]}</strong>}                   
                        ...
                        />
                        {(this.props.error.email) && <strong className='text-danger'>{this.props.error.email[0]}</strong>}  
                        ...
                        />   
                        {(this.props.error.password) && <strong className='text-danger'>{this.props.error.password[0]}</strong>}  
